...
{
    public abstract class TrialTemplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TrialTemplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TrialTemplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TrialTemplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TrialTemplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TrialTemplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TrialTemplateDbContext, Task<T>> func)
        {
            T result;
